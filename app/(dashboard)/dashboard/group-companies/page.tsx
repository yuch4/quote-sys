        ...
        <div className="relative flex items-start justify-between">
          <div className="space-y-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-slate-300">Group Company Management</p>
              </div>
            </div>
          ...
          <div className="hidden lg:flex items-center gap-4">
            <div className="flex flex-col items-center gap-1 rounded-xl bg-white/10 backdrop-blur-sm px-4 py-3">
              ...
              <span className="text-xs text-slate-300">セキュリティ</span>
            </div>
            <div className="flex flex-col items-center gap-1 rounded-xl bg-white/10 backdrop-blur-sm px-4 py-3">
              <svg className="h-6 w-6 text-turquoise-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 7v10c0 2.21 3.582 4 8 4s8-1.79 8-4V7M4 7c0 2.21 3.582 4 8 4s8-1.79 8-4M4 7c0-2.21 3.582-4 8-4s8 1.79 8 4m0 5c0 2.21-3.582 4-8 4s-8-1.79-8-4" />
              </svg>
              <span className="text-xs text-slate-300">システム棚卸</span>
            </div>
            <div className="flex flex-col items-center gap-1 rounded-xl bg-white/10 backdrop-blur-sm px-4 py-3">
              <svg className="h-6 w-6 text-turquoise-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
              </svg>
              <span className="text-xs text-slate-300">グループ連携</span>
            </div>
          </div>
        </div>
      </div>
