        ...
        <CardHeader className="space-y-4 pb-4">
          ...
          <div className="flex flex-wrap items-center justify-between gap-4">
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              <Button size="sm" onClick={openCreateDialog} disabled={loading} className="gap-1.5 bg-slate-800 hover:bg-slate-900">
                    ...
                    <TableRow key={company.id} className={`hover:bg-white/80 ${index % 2 === 0 ? 'bg-white/40' : ''}`}>
                      ...
                      <TableCell>
                        <button
                          ...
                          className="inline-flex items-center gap-1.5 rounded-full bg-teal-50 px-2.5 py-1 text-xs font-medium text-teal-700 hover:bg-teal-100 transition-colors"
                        >
                          <svg className="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
